...
namespace Vuforia
{
    ...
    /// </summary>
    public class GrouponTrackableEventHandler : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingFound()
        {
            ...
            int res = -1;
            int.TryParse(Server.GET("flags/0/claimed", ""), out res);
